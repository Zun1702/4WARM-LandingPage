  ...
  const socialLinks = [
    {
      ...
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.619 5.367 11.986 11.988 11.986s11.987-5.367 11.987-11.986C24.004 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.149-1.53L3.761 9.7c-.156-.78.624-1.426 1.429-.998l1.989 1.159c.358-.896.97-1.617 1.718-2.1L8.449 5.5c0-.437.354-.79.79-.79s.79.353.79.79l-.448 2.261c.748.483 1.36 1.204 1.718 2.1l1.989-1.159c.805-.428 1.585.218 1.429.998l-1.539 5.758c-.701 1.04-1.852 1.53-3.149 1.53s-2.448-.49-3.149-1.53l-.04-.015z"/>
        </svg>
      ),
      url: '#',
